<?php
/*
Template Name: BodyShape - Fitness, Workout & Gym HTML Template
...
try {
    if (!empty($_POST)) {
		...
		if($_POST['dzToDo'] == 'Contact')
		{
			...
			$dzMailSubject = 'BodyShape|Contact Form: A Person want to contact';
			$dzMailMessage	= 	"
		...
		if($_POST['dzToDo'] == 'Appointment')
		{
			...
			$dzMailSubject = 'BodyShape|Appointment Form: A Person want to contact';
			$dzMailMessage	= 	"
								A person want to appointment you: <br><br>
								Name: $dzName<br/>
								Email: $dzEmail<br/>".$dzPhoneMessage."";
			$dzOtherField = "";
			if(!empty($_POST['dzOther']))
